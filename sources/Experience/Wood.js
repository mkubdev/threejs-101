...
export default class Wood {
	...
	setLoadingManager() {
		...
		this.texture.woodAmbientOcclusion  = textureLoader.load('/assets/textures/wood/ambientOcclusion.jpg')
		this.texture.woodColor = textureLoader.load('/assets/textures/wood/basecolor.jpg')
		this.texture.woodHeight  = textureLoader.load('/assets/textures/wood/height.png')
		this.texture.woodNormal  = textureLoader.load('/assets/textures/wood/normal.jpg')
		this.texture.woodRoughness   = textureLoader.load('/assets/textures/wood/roughness.jpg')
	...
	setGUI() {
		...
		this.experience.debug.addInput(PARAMS, 'autorotate').on('change', (_event) => {
			if (_event.value) {
				gsap.to(this.mesh.rotation, { duration: 8, y: this.mesh.rotation.y + Math.PI * 2, repeat: -1, ease: 'none' })
			} else {
