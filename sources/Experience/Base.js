...
export default class Base {
	...
	setLoadingManager() {
		...
		this.texture.doorColor = textureLoader.load('/assets/textures/door/color.jpg')
		this.texture.doorAlpha = textureLoader.load('/assets/textures/door/alpha.jpg')
		this.texture.doorHeight = textureLoader.load('/assets/textures/door/height.png')
		this.texture.doorNormal = textureLoader.load('/assets/textures/door/normal.jpg')
		this.texture.doorAmbientOcclusion = textureLoader.load('/assets/textures/door/ambientOcclusion.jpg')
		this.texture.doorMetalness = textureLoader.load('/assets/textures/door/metalness.jpg')
		this.texture.doorRoughness = textureLoader.load('/assets/textures/door/roughness.jpg')
	...
	setGUI() {
		...
		this.experience.debug.addInput(PARAMS, 'wireframe').on('change', (_event) => {
			this.material.wireframe = _event.value
		})

		this.experience.debug.addInput(PARAMS, 'segment', { min: 2, max: 64, step: 2 }).on('change', (_event) => {
			...
			this.mesh.geometry = new THREE.BoxGeometry(2, 2, 2, PARAMS.segment, PARAMS.segment, PARAMS.segment);
		})

		this.experience.debug.addButton({ title: 'Spin' }).on('click', PARAMS.spin);
	}
